...
os.environ.setdefault("DJANGO_SETTINGS_MODULE", "chudartz.settings")
django.setup()
...
def main():
    ...
    if p:
        ...
        assert str(ticket.get_toegang_start().strftime("%H:%M")) in formatted

    long_title = (
        "Super Mega Ultra Lange Evenement Titel Die Zeker Over De QR Code Zou Gaan"
    )
